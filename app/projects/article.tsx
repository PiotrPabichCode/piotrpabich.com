...
export const Article: React.FC<Props> = ({
  ...
  return (
    <article className='p-4 md:p-8 relative'>
      <Link className='absolute inset-0' href={`/projects/${url}`}>
        <ArrowRight
          color='white'
          className='absolute cursor-pointer right-5 top-5 hover:stroke-sky-500'
        />
      </Link>
      ...
      <div className='flex gap-1 items-center'>
        ...
        {repository && (
          <Link
            href={repository}
            className='flex z-10 items-center text-sky-500 hover:underline'>
